...
import greenImg from "../public/assets/Assets/Slide_green.png";
import prupleImg from "../public/assets/Assets/Slide_purple.png";
import genericImg from "../public/assets/Assets/Slide_generic.png";
import colorFul from "../public/assets/Assets/Report_page_colourful.png";
import titlePurple from "../public/assets/Assets/Title_purple.png";
import titleGreen from "../public/assets/Assets/Title_green.png";
    ...
    <div className="relative flex gap-10  h-full group/image">
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          {/* TODO */}
          <Image src={img3} alt="header" fill className="object-fit " />
        </div>
      </div>
    </div>
  );
